...
/* __next_internal_action_entry_do_not_use__ [{"00cadb32047bc11005843e05871194bde40334b444":"getDashboardMetrics"},"",""] */ __turbopack_context__.s([
    "getDashboardMetrics",
    ()=>getDashboardMetrics
]);
...
async function getDashboardMetrics() {
    ...
    const { data: invoices } = await supabase.from("invoices").select("total_amount").eq("status", "paid");
    const totalRevenue = invoices?.reduce((acc, curr)=>acc + (curr.total_amount || 0), 0) || 0;
    // 2. Active Patients (Total count)
    const { count: activePatients } = await supabase.from("patients").select("id", {
        count: "exact",
        head: true
    });
    // 3. Appointments Today
    const { count: appointmentsToday } = await supabase.from("appointments").select("id", {
        count: "exact",
        head: true
    }).gte("start_time", today.toISOString()).lt("start_time", tomorrow.toISOString());
    // 4. Pending Tasks
    const { count: pendingTasks } = await supabase.from("tasks").select("id", {
        count: "exact",
        head: true
    }).eq("status", "pending");
    return {
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(getDashboardMetrics, "00cadb32047bc11005843e05871194bde40334b444", null);
}),
...
__turbopack_context__.s([
    "00cadb32047bc11005843e05871194bde40334b444",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$dashboard$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getDashboardMetrics"]
]);
...
//# sourceMappingURL=_ab4ef642._.js.map